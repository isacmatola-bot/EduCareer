...
describe('partner-owned member-only opportunities', () => {
  it('removes anonymous opportunity access and requires an active account', () => {
    expect(migration).toContain('revoke select on table public.opportunities from anon');
